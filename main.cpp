...
int main(void)
{
	...
	if (false == dtd.init("Z:/Smartphone_2/Shawn/Neutropenia/dad_08_18_cohorts.csv"))
		return -1;
	...
	dtd.print_to_file("Z:/Smartphone_2/Shawn/Neutropenia/dad_08_18_cohorts_with_neutropenia_indicator.csv");
	...
	if (false == ntd.init("Z:/Smartphone_2/Shawn/Neutropenia/nacrs_cohorts_08_18.csv"))
		return -1;
	...
	ntd.print_to_file("Z:/Smartphone_2/Shawn/Neutropenia/nacrs_cohorts_08_18_with_neutropenia_indicator.csv");
